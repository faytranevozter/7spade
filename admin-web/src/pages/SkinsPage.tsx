...
function CatalogImage({ skin }: { skin: Skin }) {
  ...
  return (
    <div className={`skin-card-art skin-art-${skin.skin_type}`}>
...
export function SkinsPage() {
  ...
  return (
    <section className="skin-catalog-page">
      <header className="skin-page-hero">
        <div>
      ...
      {canManage && (
        <section className="skin-create-panel">
          ...
          <div className="skin-create-fields">
            ...
            <label className="skin-field skin-create-wide">
      ...
      <div className="skin-filter-bar" aria-label="Skin filters">
        <label className="skin-field skin-search-field">
      ...
      {loading ? (
        ...
        <>
          <div className="skin-results-heading">
            <h2>Catalog</h2>
            <span>
                  ...
                  <div className="skin-card-body">
                    <div className="skin-card-title">
                      ...
                      <div className="skin-card-badges">
                        ...
                        <span
                          className={`skin-status ${!skin.enabled ? 'disabled' : skin.catalog_visible ? 'visible' : 'hidden'}`}
                        >
                          {!skin.enabled
                            ? 'Disabled'
