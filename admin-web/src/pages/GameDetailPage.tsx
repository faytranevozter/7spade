  ...
  return (
    <section className="game-detail-page" aria-labelledby="game-detail-heading">
      ...
      <header className="game-detail-hero">
        ...
        <div
          className={`replay-seal ${detail.game.replay_available ? '' : 'replay-missing'}`}
        >
          <span>
                ...
                <tbody>
                  {detail.players.map((player) => (
                    <tr
                      ...
                      className={player.is_winner ? 'winner-row' : ''}
                    >
                      <td>
                        <span className="rank-mark">{player.rank}</span>
                      </td>
                      <td>
                      ...
                      <td>
                        <div className="penalty-cards">
                          {player.facedown_cards?.length ? (
                            ...
                            <span className="no-cards">None</span>
                          )}
                        </div>
                      </td>
                    </tr>
          ...
          <section className="annotation-panel">
            ...
            <div className="annotation-list">
              {detail.flags.map((flag) => (
                <article key={flag.id} className="annotation-item flag-item">
                  <span className="annotation-type">Flag</span>
                  <strong>{flag.reason}</strong>
                  <small>{formatDateTime(flag.created_at)}</small>
                </article>
              ))}
              {detail.notes.map((note) => (
                <article key={note.id} className="annotation-item">
                  <span className="annotation-type">Note</span>
  ...
  return (
    <li className="move-item">
      ...
      {isCard ? (
        ...
        <span className="move-symbol">-</span>
      )}
    </li>
  )
}
...
function MiniCard({ card }: { card: GameCard }) {
  ...
  return (
    <span
      className={`mini-card ${red ? 'red-card' : ''}`}
