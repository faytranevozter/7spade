...
export function AdministratorsPage() {
  ...
  return (
    <section className="access-page" aria-labelledby="admins-heading">
      <header className="access-header">
        <div>
          <p className="eyebrow">Access control / Identities</p>
          <h1 id="admins-heading">Administrators</h1>
          <p>
            Invite operators, review their access posture, and manage identity
            lifecycle independently from role policy.
          </p>
        </div>
        <div className="access-header-stats">
          <div>
...
function AdministratorRow({
  ...
  return (
    <article className="administrator-row">
      <span className="admin-avatar">{initials(item.display_name)}</span>
      <div className="admin-identity">
        <div>
          <strong>{item.display_name}</strong>
          {isCurrent ? <span className="current-admin-badge">You</span> : null}
      ...
      <div className="admin-security">
        <span
          className={item.mfa_enrolled ? 'security-good' : 'security-warning'}
        >
      ...
      {canManage && !isCurrent ? (
        ...
        <div className="admin-row-actions">
          <span className="locked-identity">
