...
export function UserInvestigation({
  ...
  return (
    <section
      className="user-investigation-page"
      aria-labelledby="users-heading"
    >
      <header className="user-investigation-header">
        <div>
          <p className="eyebrow">Operations / Player investigations</p>
      ...
      <section
        className="user-directory-panel"
  ...
  return (
    ...
    >
      ...
      <div className="user-access-state">
        <span
          className={user.suspension ? 'access-suspended' : 'access-active'}
        >
      ...
      <div className="user-presence">
        <span
          className={user.online ? 'presence-dot online' : 'presence-dot'}
        />
        <div>
