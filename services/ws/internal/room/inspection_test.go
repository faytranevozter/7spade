...
func newTestOwnership(token int64) *cluster.Ownership {
	o := cluster.NewOwnership("test", nil, nil)
	o.Promote(context.Background(), token, true, nil)
	return o
}
