...
1. Deploy one API task from the new image to apply the consolidated reward migration `033_achievement_skin_rewards.sql`, but do not route player traffic to the new API version yet.
