...
describe('classifySpectatorReaction', () => {
  test('shows the first emotes in a window individually', () => {
  ...
  test('aggregates emotes beyond the individual limit, counting up', () => {
    let window = newSpectatorReactionWindow()
  ...
  test('resets to individual once the window elapses', () => {
    let window = newSpectatorReactionWindow()
